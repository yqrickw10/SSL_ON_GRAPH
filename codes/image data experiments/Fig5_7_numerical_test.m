...
%% read image data
IM=imread('Data/beach_painted.png');
IM_full=imread('Data/beach.png');
...
image(part_beach);
title('beach')% R
imwrite(part_beach,'A_beach.png');
%
subplot(223)
part_sea=IM_full;
