% Numerical experiment on the 2-layer Wikipedia data set [2]
...
% [2] Nikhil Rasiwasia, Jose Costa Pereira, Emanuele Coviello, Gabriel Doyle, Gert R.G. Lanckriet, Roger Levy, and Nuno Vasconcelos. A new approach to cross-modal multimedia retrieval. In Proceedings of the 18th ACM international conference on Multimedia, pages 251-260. ACM, 2010. 
...
load Data/WikipediaArticles.mat

fprintf('Wikipedia dataset k = %3d, mean error in percent\n', k);
fprintf('================================================\n');
fprintf('known  ');
