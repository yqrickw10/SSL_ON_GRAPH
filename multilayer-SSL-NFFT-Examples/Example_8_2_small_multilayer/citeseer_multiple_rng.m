% Numerical experiment on the single layer Citeseer data set [2]
...
% [2] Q. Lu and L. Getoor. Link-based classification. In Proceedings of the 20th International Conference on Machine Learning (ICML-03), 2003, pp. 496-503.
...
fprintf('Citeseer dataset k = %3d, mean error in percent\n', k);
fprintf('===============================================\n');
fprintf('known  ');
