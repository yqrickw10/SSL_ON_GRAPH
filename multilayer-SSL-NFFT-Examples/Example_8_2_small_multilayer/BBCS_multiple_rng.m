% Numerical experiment on the 2-layer BBCs data set [2]
...
% [2] D. Greene and P. Cunningham. A matrix factorization approach for integrating multiple data views. In Joint European Conference on Machine Learning and Knowledge Discovery in Databases, Springer, 2009, pp. 423-438.
...
load Data/BBCSport2view_544.mat

fprintf('BBCS dataset k = %3d, mean error in percent\n', k);
fprintf('===========================================\n');
fprintf('known  ');
